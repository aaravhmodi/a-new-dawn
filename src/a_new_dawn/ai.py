    ...
    def _fallback_episode_plan(self, campaign_arc: dict[str, Any], episode_number: int, player_class: str) -> dict[str, Any]:
        ...
        return {
            ...
            "scenes": [
                ...
                {
                    "scene_key": f"{prefix}_archive_entry",
                    ...
                    "choices": [
                        {
                            "choice_key": "slice_archive",
                            "label": "Slice the archive terminal",
                            "description": "Extract the stolen data quietly and leave no witnesses.",
                            "outcome": "Encrypted files reveal a cell called Directorate Null moving against both Sith and Jedi assets.",
                            "next_scene_key": f"{prefix}_intercept",
                            "effects": {"set_flags": ["black_codex_fragment_found"], "light_delta": 1},
                        },
                        {
                            "choice_key": "erase_records",
                            "label": "Erase the watcher logs",
                            "description": "Protect your cover by wiping every trace of your entry.",
                            "outcome": "You leave with less data, but your alias survives the night.",
                            "next_scene_key": f"{prefix}_intercept",
                            "effects": {"independent_delta": 2, "set_flags": ["cover_preserved"]},
                        },
                        {
                            "choice_key": "pin_rival",
                            "label": f"Plant evidence against {rival}",
                            "description": "Turn suspicion toward the official already hunting you.",
                            "outcome": f"Security red-flags {rival}'s team, buying you time at the cost of escalating the conspiracy.",
                            "next_scene_key": f"{prefix}_intercept",
                            "effects": {"dark_delta": 2, "set_flags": ["rival_compromised"]},
                        },
                    ],
                },
                {
